...
<div class="post_create_container d-flex">
  <div class="post_create_area border w-50 m-5 p-5">
    <div class="">
      ...
      <select class="w-100" form="postCreate" name="post_category">
        @foreach($main_categories as $main_category)
        <optgroup label="{{ $main_category->main_category }}" style="color:gray"></optgroup>
        <!-- サブカテゴリー表示 -->
      ...
      <div class="">
       ...
       @endif
        <p class="m-0">サブカテゴリー</p>
         <select name="main_category_id" form="subCategoryRequest" class="" >
